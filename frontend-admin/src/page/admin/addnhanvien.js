            ...
            <div class="col-sm-12">
                <form onSubmit={handleAddNhanVien} class="form-add row">
                    ...
                    <div className='col-sm-5'>
                        ...
                        <select name='vaiTro' defaultValue={item?.vaiTro} class="form-control">
                            <option selected={item?.vaiTro == 1} value={1}>Admin</option>
                            <option selected={item?.vaiTro == 0} value={0}>Nhân viên</option>
                        </select>
